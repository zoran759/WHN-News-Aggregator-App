...
class CommentVote(Vote):
    ...
    def __unicode__(self):
        return self.voter.username + " " + str(self.score) + " on " + self.comment.post.title + " by " + self.comment.author.username
...
class PostFlag(models.Model):
    ...
    def __unicode__(self):
        return self.flagger.username + " flagged " + self.post.title
